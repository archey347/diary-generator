 ...
 <body>
    ...
    <form method="POST">
        ...
        <div id="birthdays" class="birthdays">
                <table><tr><td>Name<br><input type="text" name="birthperson1" id="birthperson1" style="width: 200px;"/></td><td>Date<br><input name="birthdate1" id="birthdate1" type="date"></td></tr></table>
       </div>
